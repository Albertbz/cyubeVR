...
class AFirstPersonCharacterVR_C : public AVRCharacter
{
    ...
    float LastFootstepPlayed;
    FVector2D LastFootstepPlayedLocation;
    bool PlayingHeartbeat;
    float LastHeartbeatPlayed;
    ...
    void PlayShoulderAddToInventoryHaptics(bool Right);
    void CheckPlayHeartbeat();
    void PlayFootstepSounds();
    void Mark Block Item Detached(class ABlockItem* BlockItem);
    ...
    void CheckWorldEdge();
    void SpawnDeadBodyF();
    void ReduceHealth(float Amount, FString Reason);
    ...
    void InpActEvt_SnapTurnLeft_K2Node_InputActionEvent_55(FKey Key);
    void InpActEvt_SnapTurnRight_K2Node_InputActionEvent_54(FKey Key);
    void InpActEvt_InventoryClick_K2Node_InputActionEvent_53(FKey Key);
    void InpActEvt_InventoryClick_K2Node_InputActionEvent_52(FKey Key);
    ...
    void InpActEvt_PlaceBlockRight_K2Node_InputActionEvent_45(FKey Key);
    void InpActEvt_PlaceBlockRight_K2Node_InputActionEvent_44(FKey Key);
    void InpActEvt_PlaceBlockLeft_K2Node_InputActionEvent_43(FKey Key);
    void InpActEvt_PlaceBlockLeft_K2Node_InputActionEvent_42(FKey Key);
